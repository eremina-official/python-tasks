...
# itertools is a Python standard-library module that provides fast,
# memory-efficient iterator building blocks (inspired by functional programming)
# for looping, combining, and transforming data without creating intermediate lists.
...
# tools for wrapping, composing, caching, and adapting functions.
